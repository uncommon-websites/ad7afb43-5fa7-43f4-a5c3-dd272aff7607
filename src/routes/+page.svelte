...
<div class="min-h-screen flex flex-col justify-center items-center p-6 sm:p-8 md:p-12 lg:p-16 font-sans text-[#000000] bg-white selection:bg-gray-200">
	...
	<div class="flex flex-col justify-center max-w-[900px] mr-auto text-left">
		...
		<!-- Body Text -->
		<div class="my-6 text-lg sm:text-xl md:text-[1.25rem] leading-[1.6] text-[#0F0F0F] font-normal tracking-tight animate-fade-in-slide-up animate-delay-100">
			<p>
		...
		<!-- CTA -->
		<p class="text-lg sm:text-xl md:text-[1.25rem] leading-[1.6] text-[#0F0F0F] font-normal tracking-tight animate-fade-in-slide-up animate-delay-200">
