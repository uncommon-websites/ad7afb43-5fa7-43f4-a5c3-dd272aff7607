...
<div class="min-h-screen flex flex-col justify-between p-6 sm:p-8 md:p-12 lg:p-16 font-sans text-[#111] bg-white selection:bg-gray-200">
	...
	<div class="flex-1 flex flex-col justify-center max-w-[900px]">
		...
		<!-- Headline -->
		<h1 class="text-lg sm:text-xl md:text-2xl leading-[1.3] font-bold tracking-tight text-black">
		...
		<!-- Body Text -->
		<div class="my-6 text-base sm:text-lg md:text-[1.1rem] leading-[1.6] text-[#888888] font-normal tracking-tight">
			<p>
